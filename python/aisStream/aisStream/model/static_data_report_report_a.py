...
class StaticDataReportReportA(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, valid, name, *args, **kwargs):  # noqa: E501
        """StaticDataReportReportA - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, valid, name, *args, **kwargs):  # noqa: E501
        """StaticDataReportReportA - a model defined in OpenAPI
