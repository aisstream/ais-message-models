...
class ShipStaticDataEta(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, month, day, hour, minute, *args, **kwargs):  # noqa: E501
        """ShipStaticDataEta - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, month, day, hour, minute, *args, **kwargs):  # noqa: E501
        """ShipStaticDataEta - a model defined in OpenAPI
