...
class CoordinatedUTCInquiry(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, message_id, repeat_indicator, user_id, valid, spare1, destination_id, spare2, *args, **kwargs):  # noqa: E501
        """CoordinatedUTCInquiry - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, message_id, repeat_indicator, user_id, valid, spare1, destination_id, spare2, *args, **kwargs):  # noqa: E501
        """CoordinatedUTCInquiry - a model defined in OpenAPI
