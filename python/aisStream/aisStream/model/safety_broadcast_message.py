...
class SafetyBroadcastMessage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, message_id, repeat_indicator, user_id, valid, spare, text, *args, **kwargs):  # noqa: E501
        """SafetyBroadcastMessage - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, message_id, repeat_indicator, user_id, valid, spare, text, *args, **kwargs):  # noqa: E501
        """SafetyBroadcastMessage - a model defined in OpenAPI
